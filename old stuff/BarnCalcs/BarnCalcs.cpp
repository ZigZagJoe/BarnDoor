...
const long double A = 30.1551L; // arm (the moving bit) of mount
const long double B = 30.3560L; // base of mount

const long double FIXED_ANGLES = 4.5L + /* angle from upper board to screw pivot) */
                                 4.5L   /* angle from lower board to drive pivot) */;

const long double S = (FIXED_ANGLES + /* unchanging angles */
                       2.7335L        /* angle between two boards when rewound */
...
const long double THREADS_PER_CM = 20.0L /* per in */ / IN2CM; // of drive rod
